    ...
    <section id="how-it-works" className="py-24 md:py-32 bg-surface/30">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-14 left-0 right-0 h-px bg-gradient-to-r from-transparent via-solana-purple/30 to-transparent" />
              ...
              <AnimateIn key={step.step} delay={i * 150}>
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="relative mb-6">
                    <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[rgba(153,69,255,0.12)] to-[rgba(20,241,149,0.06)] border border-[rgba(153,69,255,0.2)] flex items-center justify-center">
                      <step.icon size={32} className="text-solana-purple" />
                    </div>
                    {/* Step number badge */}
                    <div className="absolute -top-1 -right-1 w-8 h-8 rounded-full bg-solana-purple text-background text-sm font-bold flex items-center justify-center shadow-[0_0_16px_rgba(153,69,255,0.4)]">
                      {step.step}
                    </div>
                  </div>
